...
public class CustomListAdapter extends BaseAdapter {
    ...
    public CustomListAdapter(Context context, ArrayList<Task> tasks, Button addTask, boolean displayDate) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        Button editItem = (Button) view.findViewById(R.id.btnEditItem);
        Button deleteItem = (Button) view.findViewById(R.id.btnDeleteItem);
