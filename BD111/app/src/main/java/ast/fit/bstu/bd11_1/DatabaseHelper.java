...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void createTableStudent(SQLiteDatabase db) {
        try {
            ...
            db.execSQL("INSERT INTO " + TABLE_STUDENT_NAME +
                    ...
                    " VALUES (1,'Владислав Савин','27.02.2001','ул. Белорусская 21');");
            db.execSQL("INSERT INTO " + TABLE_STUDENT_NAME +
                    " (" + STUDENT_COLUMN_IDGROUP + "," + STUDENT_COLUMN_NAME + "," + STUDENT_COLUMN_BIRTHDATE + "," + STUDENT_COLUMN_ADDRESS + ") " +
                    " VALUES (1,'Марк Степанюк','10.12.2000','ул. Связистов 10-123');");
            db.execSQL("INSERT INTO " + TABLE_STUDENT_NAME +
                    " (" + STUDENT_COLUMN_IDGROUP + "," + STUDENT_COLUMN_NAME + "," + STUDENT_COLUMN_BIRTHDATE + "," + STUDENT_COLUMN_ADDRESS + ") " +
                    " VALUES (2,'Анна Кривцова','15.05.1999','ул. Аграрная 29-12');");
            db.execSQL("INSERT INTO " + TABLE_STUDENT_NAME +
                    " (" + STUDENT_COLUMN_IDGROUP + "," + STUDENT_COLUMN_NAME + "," + STUDENT_COLUMN_BIRTHDATE + "," + STUDENT_COLUMN_ADDRESS + ") " +
                    " VALUES (3,'Антон Блинов','03.01.2001','ул. Карла Маркса 40-24');");
            db.execSQL("INSERT INTO " + TABLE_STUDENT_NAME +
                    " (" + STUDENT_COLUMN_IDGROUP + "," + STUDENT_COLUMN_NAME + "," + STUDENT_COLUMN_BIRTHDATE + "," + STUDENT_COLUMN_ADDRESS + ") " +
                    " VALUES (4,'Владислав Матусевич','22.02.2003','ул. Денисовская 123-32');");
            db.execSQL("INSERT INTO " + TABLE_STUDENT_NAME +
                    " (" + STUDENT_COLUMN_IDGROUP + "," + STUDENT_COLUMN_NAME + "," + STUDENT_COLUMN_BIRTHDATE + "," + STUDENT_COLUMN_ADDRESS + ") " +
                    " VALUES (5,'Никита Ашитко','12.09.2000','ул. Скорины 51-30');");
            db.execSQL("INSERT INTO " + TABLE_STUDENT_NAME +
                    " (" + STUDENT_COLUMN_IDGROUP + "," + STUDENT_COLUMN_NAME + "," + STUDENT_COLUMN_BIRTHDATE + "," + STUDENT_COLUMN_ADDRESS + ") " +
                    " VALUES (1,'Александра Комкова','15.06.2001','ул. Белорусская 21');");
            db.execSQL("INSERT INTO " + TABLE_STUDENT_NAME +
                    " (" + STUDENT_COLUMN_IDGROUP + "," + STUDENT_COLUMN_NAME + "," + STUDENT_COLUMN_BIRTHDATE + "," + STUDENT_COLUMN_ADDRESS + ") " +
                    " VALUES (1,'Дарья Зизико','02.12.2001','ул. Белорусская 21');");
            db.execSQL("INSERT INTO " + TABLE_STUDENT_NAME +
                    " (" + STUDENT_COLUMN_IDGROUP + "," + STUDENT_COLUMN_NAME + "," + STUDENT_COLUMN_BIRTHDATE + "," + STUDENT_COLUMN_ADDRESS + ") " +
                    " VALUES (1,'Иван Клишевич','15.12.2001','ул. Белорусская 21');");
            db.execSQL("INSERT INTO " + TABLE_STUDENT_NAME +
                    " (" + STUDENT_COLUMN_IDGROUP + "," + STUDENT_COLUMN_NAME + "," + STUDENT_COLUMN_BIRTHDATE + "," + STUDENT_COLUMN_ADDRESS + ") " +
                    " VALUES (2,'Олег Мелешков','25.09.1999','ул. Аграрная 29-12');");
            db.execSQL("INSERT INTO " + TABLE_STUDENT_NAME +
                    " (" + STUDENT_COLUMN_IDGROUP + "," + STUDENT_COLUMN_NAME + "," + STUDENT_COLUMN_BIRTHDATE + "," + STUDENT_COLUMN_ADDRESS + ") " +
                    " VALUES (2,'Антон Другов','15.05.1999','ул. Аграрная 29-12');");
        }
    }
    ...
    private void createTableProgress(SQLiteDatabase db) {
        try {
            ...
            db.execSQL("INSERT INTO " + TABLE_PROGRESS_NAME +
                    " (" + PROGRESS_COLUMN_IDSTUDENT + "," + PROGRESS_COLUMN_IDSUBJECT + "," + PROGRESS_COLUMN_EXAMDATE + "," + PROGRESS_COLUMN_MARK + "," + PROGRESS_COLUMN_TEACHER + ") " +
                    " VALUES (4,2,'2019-01-14',6,'Пацей');");
            db.execSQL("INSERT INTO " + TABLE_PROGRESS_NAME +
                    " (" + PROGRESS_COLUMN_IDSTUDENT + "," + PROGRESS_COLUMN_IDSUBJECT + "," + PROGRESS_COLUMN_EXAMDATE + "," + PROGRESS_COLUMN_MARK + "," + PROGRESS_COLUMN_TEACHER + ") " +
                    " VALUES (10,2,'2019-01-14',2,'Пацей');");
    ...
    //DELETE FROM STUDENT ? IDSTUDENT=11
